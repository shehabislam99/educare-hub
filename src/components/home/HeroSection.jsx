           ...
           <div className="grid lg:grid-cols-2 gap-12 items-center">
             ...
             >
               ...
               <p className="text-xl text-slate-600 dark:text-slate-300 mb-10 leading-relaxed max-w-2xl mx-auto">
                 Join over 25 thousand learners and start your journey today.
                 Access high-quality courses from industry experts and top
                 universities.
               </p>
               <div className="flex flex-col sm:flex-row gap-4">
                 ...
                 <Button
                   variant="outline"
                   size="lg"
                   className="text-lg hover:bg-indigo-50 hover:border-indigo-300"
                 >
             ...
             <motion.div
               ...
               className="relative"
             >
               <div className="relative z-10 rounded-3xl overflow-hidden  shadow-md shadow-indigo-50 dark:shadow-indigo-950/60 border-8 border-white dark:border-slate-900">
                 <img
                   src={image.src || image}
