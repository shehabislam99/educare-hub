               ...
               <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                         ...
                         >
                              ...
                              <h1 className="text-5xl lg:text-7xl font-bold font-display tracking-tight text-slate-900 leading-[1.1] mb-6">
                                   Master New Skills <br />
                                   <span className="text-indigo-600">Anytime, Anywhere</span>
                              </h1>
                              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl">
                                   Join over 25 million learners and start your journey today. Access high-quality courses from industry experts and top universities.
                              </p>
                              <div className="flex flex-col sm:flex-row gap-4">
                                   <Link href="/course" className="px-5 py-2 border text-white rounded bg-indigo-600 flex items-center justify-center gap-2 text-lg">
                                        Get Started <ArrowRight className="w-5 h-5" />
                                   </Link>
                                   <button className="flex items-center justify-center gap-2 text-lg px-8 border rounded hover:bg-slate-50 text-slate-700 font-bold transition-all py-2">
                              ...
                              <div className="mt-12 flex items-center gap-8">
                                   ...
                                   <div>
                                        ...
                                        <p className="text-sm text-slate-500 font-medium">Trusted by 25,000+ students</p>
                                   </div>
                              </div>
                         </motion.div>
